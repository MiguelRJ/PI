package com.mrj.morejmoney.data.prefs;
...
public interface AccountPreferencesHelper {
    ...
    String PREF_KEY_CURRENT_REMEMBER="PREF_KEY_CURRENT_REMEMBER";
    String PREF_KEY_ICON="PREF_KEY_ICON";
    String PREF_KEY_ICON_SHOW="PREF_KEY_ICON_SHOW";
