...
public class TransactionRepository {
    ...
    private void initialize() {
        ...
        addTransaction(new Transaction(1,0,0,0,true,75,"1234567890",36.719116, -4.453754,null));
        ...
        addTransaction(new Transaction(3,0,1,0,true,25,"12345678901234567890",36.719116, -4.453754,new byte[]{1,2,3,4,5}));
        ...
        addTransaction(new Transaction(5,0,1,0,false,125,"123456789012345678901234567890",36.719116, -4.453754,new byte[]{1,2,3,4,5}));
        ...
        addTransaction(new Transaction(1,1,1,0,true,75,"1234567890",36.719116, -4.453754,new byte[]{1,2,3,4,5}));
        ...
        addTransaction(new Transaction(3,1,0,0,true,25,"12345678901234567890",36.719116, -4.453754,new byte[]{1,2,3,4,5}));
        ...
        addTransaction(new Transaction(5,1,0,0,false,125,"123456789012345678901234567890",36.719116, -4.453754,new byte[]{1,2,3,4,5}));
